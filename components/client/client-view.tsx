 ...
 * placed on the canvas. Shows the agency-branded overview the client sees:
 * brand header, current stage tracker, calendar, and shared links. A link opens
 * the full portal in a new tab.
 */
export function ClientView() {
  const project = resolveClientProject('aurora')
