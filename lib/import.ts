...
export const MCP_SOURCES: McpSource[] = [
  {
    ...
    detail: 'Hero · Logos · Features · Pricing · CTA',
    build: () => [
      newSection('Navbar', 'imported'),
      newSection('Hero', 'imported'),
      newSection('LogoRow', 'imported'),
      newSection('FeatureGrid', 'imported'),
      newSection('Pricing', 'imported'),
      newSection('CTABand', 'imported'),
      newSection('Footer', 'imported'),
    ],
  },
  {
    id: 'mcp-about',
    name: 'About / company page',
    detail: 'Hero · Feature media · Testimonials',
    build: () => [
      newSection('Hero', 'imported'),
      newSection('FeatureMedia', 'imported'),
      newSection('Testimonials', 'imported'),
    ],
  },
  {
    id: 'mcp-support',
    name: 'Support / FAQ page',
    detail: 'Hero · FAQ · CTA',
    build: () => [
      newSection('Hero', 'imported'),
      newSection('FAQ', 'imported'),
      newSection('CTABand', 'imported'),
    ],
  },
]
